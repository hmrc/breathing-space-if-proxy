...
object BaseError extends Enum[BaseError] {
  ...
  case object INVALID_DETAIL_INDEX
      extends BaseError(BAD_REQUEST, "Invalid detail index. Must be a number between 0 and ")
  case object INVALID_ENDPOINT extends BaseError(NOT_FOUND, "Not a valid endpoint")
